					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">WeblO ApplO</h4>
							</div>
												...
												<fieldset>
                                                    <label class="block clearfix {{ $errors->has('email') ? ' has-error' : '' }}">
														<span class="block input-icon input-icon-right">
															<input type="email" name="email" class="form-control" value="{{ $email or old('email') }}" placeholder="abc@gmail.com" required />
